  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      value: 'hello@iosdev.com',
      link: 'mailto:hello@iosdev.com'
    },
    {
      icon: Phone,
      title: 'Phone',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              ...
              and discuss how we can create an exceptional user experience together.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="space-y-4">
                <a
                  href="https://calendly.com/iosdev"
                  target="_blank"
            ...
            >
              ...
              <p className="text-blue-100 text-sm">
                ...
                within 1-2 weeks depending on scope.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "I provide regular updates through your preferred communication channel (Slack, email, or video calls). You'll receive weekly progress reports and have direct access to me throughout the project."
              },
              {
                question: "What's included in the project cost?",
                answer: "The cost includes development, testing, App Store submission, source code, and the specified support period. Additional features or changes outside the original scope may incur extra costs."
              },
              {
                question: "Do you provide ongoing maintenance?",
                answer: "Yes! I offer maintenance packages that include bug fixes, iOS compatibility updates, and minor feature additions. This ensures your app stays current with the latest iOS versions."
              },
              {
                question: "Can you help with App Store optimization?",
                answer: "Absolutely! I handle the complete App Store submission process, including metadata optimization, screenshot creation, and addressing any review feedback to ensure approval."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
